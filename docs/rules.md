...
Crewrift is a multiplayer social deduction Coworld used for social AI benchmarks.
...
Once at the task, the crewmate needs to press the emergency button and stand still until the task progress bar is complete.
...
Even maybe "faking" doing tasks, standing still where a task needs to be done.
...
They need to stand next to the victim and press the emergency button to kill.
